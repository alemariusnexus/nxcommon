...
class MySQLPreparedStatementResultInstanceImpl : public SQLResultImpl
{
public:
...
private:
	MySQLPreparedStatementResultInstanceImpl(MySQLPreparedStatementResultImpl* impl);

private:
	MySQLPreparedStatementResultImpl* impl;


	friend class MySQLPreparedStatementImpl;
};

#endif /* MYSQLPREPAREDSTATEMENTRESULTINSTANCEIMPL_H_ */
