 ...
 *
 * 	This class is built upon the basic Cache class. Internally, it acts much in the same way, but its
 * 	external interface is different. See documentation of the Cache class for information on how this cache
 * 	works in general.
 *
 ...
 */
template<class K, class Compare = less<K>, class MapHash = CXX11Hash<K>, class KeyEqual = equal_to<K> >
class ResourceCache {
private:
	class SharedPointer;
...
public:
	...
	public:
		 ...
		 */
		bool isValid() const { return sharedPtr != NULL; }
